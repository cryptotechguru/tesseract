...
public:
    CMainParams() {
        ...
        // TESR_TODO: replace above two values with updated values.
        ...
        checkpointData = {
            {
                // TESR_TODO: Update the checkpoint data once enough blocks are mined 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// TESR_TODO Temporary to mine the genesis block below
...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    // genesis block produces 0 tesseracts 
    const CScript genesisOutputScript = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
    return CreateGenesisBlock(pszTimestamp, genesisOutputScript, nTime, nNonce, nBits, nVersion, genesisReward);
}

// TESR_TODO: Temporary method to mine a genesis block
...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 0;
        consensus.BIP66Height = 0;
        // TESR_TODO temporary to mine genesis block below
        ...
        // The best chain should have at least this much work.
        //! TESR_TODO: Update in future iterations 
        consensus.nMinimumChainWork = uint256S("0x00");
        ...
        // service bits we want, but we should get them updated to support all service bits wanted by any
        // release ASAP to avoid it where possible.
        // TESR_TODO Add TESR mainnet seeds
        vFixedSeeds.clear();
        vSeeds.clear();

        base58Prefixes[PUBKEY_ADDRESS] = { 0x03, 0x5f, 0x7d }; // "TSa" prefix on address. 
        base58Prefixes[SCRIPT_ADDRESS] = { 0x03, 0x5f, 0xa7 }; // "TSs" prefix on address.
