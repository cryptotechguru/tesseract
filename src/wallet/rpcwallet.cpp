...
#else // BUILD_TESR
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Tesseract address: ") + name_);
#endif // END_BUILD 
        }
...
#else // BUILD_TESR
            "Each key is an Tesseract address or hex-encoded public key.\n"
#endif // END_BUILD 
...
#else // BUILD_TESR
    return "wallet encrypted; Tesseract server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
#endif // END_BUILD 
}
...
#else // BUILD_TESR
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Tesseract address: ") + input.get_str());
#endif // END_BUILD 
            }
