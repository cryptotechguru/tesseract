...
/** A hasher class for Tesseract's 256-bit hash (single SHA-3). */
class CSHA3Hash256 {
private:
    CSHA3 sha;
public:
...
/** A hasher class for Tesseract's 160-bit hash (SHA-3 + RIPEMD-160). */
class CSHA3Hash160 {
private:
    CSHA3 sha;
public:
...
// TESR_TODO #ifdef moved down below definition of Hash temporarily for Base58Check (#211)
// #ifdef BUILD_BTC
