...
class HTTPBasicsTest (BitcoinTestFramework):
    ...
    def setup_chain(self):
        super().setup_chain()
        #Append rpcauth to tesseract.conf before initialization
        ...
        with open(os.path.join(self.options.tmpdir+"/node0", "tesseract.conf"), 'a', encoding='utf8') as f:
            f.write(rpcauth+"\n")
            f.write(rpcauth2+"\n")
        with open(os.path.join(self.options.tmpdir+"/node1", "tesseract.conf"), 'a', encoding='utf8') as f:
            f.write(rpcuser+"\n")
            f.write(rpcpassword+"\n")
